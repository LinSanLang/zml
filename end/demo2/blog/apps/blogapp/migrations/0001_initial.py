    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='2927361944@qq.com', max_length=254, verbose_name='个人邮箱')),
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.Categroy', verbose_name='分类'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
